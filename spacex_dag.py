...
for rocket in rocket_list:
    ...
    while execution_date['year'] <= 2021:
        t1 = BashOperator(
            ...
            #params={"rocket": rocket}
            bash_command = "python3 /root/airflow/dags/spacex/load_launches.py -y {execution_date} -o /var/data/year={execution_date}/rocket={rocket} -r {rocket}".format(execution_date = execution_date['year'], rocket = rocket),
            dag=dag
        )
